...
def main():
  ...
  augdata1 = AugMixDataset(train_data, process, args.no_jsd).dataset
  augdata2 = AugMixDataset(train_data, process, args.no_jsd).dataset
  train_data.train_data = np.concatenate((train_data.train_data, augdata1.train_data, augdata2.train_data), axis=0)
  train_data.train_labels = np.concatenate((train_data.train_labels, train_data.train_labels, train_data.train_labels), axis=0)
